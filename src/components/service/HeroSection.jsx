        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 lg:order-2 flex flex-col justify-center space-y-6">
            <h1 className="font-serif font-bold text-4xl lg:text-5xl xl:text-6xl text-[#232323] leading-tight">
              Smart Bookkeeping for<br />
              Global Entrepreneurs
            </h1>
            
            <p className="text-[#232323] text-lg lg:text-xl leading-relaxed max-w-2xl">
              Focus on growing your business while we handle the numbers. BR.LK provides seamless bookkeeping and accounting support for your UK or USA company—covering tax filings, transaction reconciliation, and financial reports. Stay compliant, save time, and gain peace of mind with our expert team and easy online platform.
            </p>
