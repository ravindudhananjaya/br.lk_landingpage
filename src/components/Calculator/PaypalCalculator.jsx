    ...
    <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8 bg-white rounded-[24px]">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <SectionCard title="Listing Detail" className="">
          ...
          <div className="mt-6 bg-[#eafff1] text-[#14532d] rounded-2xl p-3 sm:p-4 text-sm">
            <div className="font-semibold mb-1">Fee Information</div>
            PayPal fees in Sri Lanka typically range from 2.9% for domestic transactions to 4.4% + fixed fee for international transactions. Cross-border fees and currency conversion charges may apply.
          </div>
        ...
        <div className="bg-[#1976e7] text-white rounded-xl px-4 sm:px-5 py-3 sm:py-4 flex items-center justify-between w-full">
