...
const CtaButton = ({ icon, label, href = "#" }) => (
  <a
    href={href}
    className="group inline-flex items-center justify-between gap-3 bg-white text-[#232323] rounded-xl px-10 py-6 min-w-100 shadow-sm ring-1 ring-black/5 hover:shadow-md transition"
  >
    ...
    <section className="bg-[#f3ede6] py-12 md:py-16 flex flex-col ">
      <div className="max-w-[900px] mx-auto px-4 flex flex-col items-center text-center gap-y-4">
        <div className="mb-3 flex justify-center">
          <img src={handPng} alt="Helping Hand" className="w-60 h-60 object-contain" />
        </div>
