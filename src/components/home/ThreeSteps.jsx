...
const steps = [
  {
    icon: <img src={step1Icon} alt="Choose Your Package" className="w-16 h-16 md:w-20 md:h-20 mb-4" />,
  ...
  {
    icon: <img src={step2Icon} alt="Submit Your Details" className="w-16 h-16 md:w-20 md:h-20 mb-4" />,
  ...
  {
    icon: <img src={step3Icon} alt="Receive Confirmation and Documents" className="w-16 h-16 md:w-20 md:h-20 mb-4" />,
...
const ThreeSteps = () => (
  <section className="bg-[#f3ede6] py-8 md:py-12 flex flex-col items-center">
    <h2 className="font-serif font-bold text-2xl md:text-3xl lg:text-5xl text-center mb-3 text-[#232323]">
