...
const TestimonialCard = ({
  ...
  return (
  <div className={`bg-white rounded-2xl py-5 px-5 shadow-sm border border-gray-100 flex flex-col overflow-hidden w-[260px] xs:w-[280px] sm:w-[300px] md:w-[340px] lg:w-[360px] xl:w-[380px] min-h-[250px] ${className}`}>
      {/* Header with avatar, name, title and rating */}
      <div className=" flex flex-col  items-start justify-between mb-4 flex-shrink-0 md:flex-row lg:flex-row  xl:flex-row">
